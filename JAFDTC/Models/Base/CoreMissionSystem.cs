...
namespace JAFDTC.Models.Base
{
    ...
    public partial class CoreMissionSystem : SystemBase
    {
        ...
        /// <summary>
        /// returns loadout for ship at given position in flight on [1, 4].
        /// </summary>
        public string LoadoutForDash(int dash)
        {
            if (string.IsNullOrEmpty(Loadouts[dash - 1]))
                dash = ((dash == 4) && !string.IsNullOrEmpty(Loadouts[2])) ? 3 : 1;
